<template>
  <div class="plaćanjegot">
    ...
    <form @submit.prevent="spremiBazaGot" class="form-group col-md-4" style="display: inline-block;">
        ...
        <p><strong>Plaćanje se odvija u poslovnici</strong></p>
        <div>
            <!--
...
export default {
  ...
  methods: {
    async spremiBazaGot() { 
      ...
      console.log('Rezultat prijave ', success4);

      if (success4 == true){ // ako se prijava dogodila, redirekcija na stranicu
